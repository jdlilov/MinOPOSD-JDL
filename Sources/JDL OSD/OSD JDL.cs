...
//            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Center", pan.panCenter, 13, 8, panCenter_en_ADDR, panCenter_x_ADDR, panCenter_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Pitch", pan.panPitch, 24, 9, panPitch_en_ADDR, panPitch_x_ADDR, panPitch_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Roll", pan.panRoll, 24, 10, panRoll_en_ADDR, panRoll_x_ADDR, panRoll_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Battery Voltage", pan.panBatt_A, 22, 3, panBatt_A_en_ADDR, panBatt_A_x_ADDR, panBatt_A_y_ADDR);
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Visible Sats", pan.panGPSats, 12, 13, panGPSats_en_ADDR, panGPSats_x_ADDR, panGPSats_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS Lock", pan.panGPL, 15, 13, panGPL_en_ADDR, panGPL_x_ADDR, panGPL_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS Coord", pan.panGPS, 1, 13, panGPS_en_ADDR, panGPS_x_ADDR, panGPS_y_ADDR);

            //second 8
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Heading Rose", pan.panRose, 16, 13, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR);

//            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Heading", pan.panHeading, 24, 12, panHeading_en_ADDR, panHeading_x_ADDR, panHeading_y_ADDR);
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Home Direction & Distance", pan.panHomeDir, 11, 5, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Home Line-Of-Sight Distance", pan.panHomeDis, 16, 12, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Waypoint Distance & ETA", pan.panWPDir, 10, 1, panWPDir_en_ADDR, panWPDir_x_ADDR, panWPDir_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Safety Radius & Eff/Glide Est.", pan.panSR_EGE, 1, 8, panSR_EGE_en_ADDR, panSR_EGE_x_ADDR, panSR_EGE_y_ADDR);
            // rssi

            // third 8
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS Altitude (ASL) & GPS AAH", pan.panAlt, 1, 12, panAlt_en_ADDR, panAlt_x_ADDR, panAlt_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Baro Altitude-Above-Home (AAH)", pan.panHomeAlt, 23, 6, panHomeAlt_en_ADDR, panHomeAlt_x_ADDR, panHomeAlt_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Climb Rate", pan.panClimb, 1, 5, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Energy Used & Battery Percent", pan.panBatteryPercent, 22, 1, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR);
            
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Current", pan.panCur_A, 22, 4, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR);
            
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Ground Speed", pan.panVel, 24, 11, panVel_en_ADDR, panVel_x_ADDR, panVel_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("3D Speed / Air Speed", pan.panAirSpeed, 1, 6, panAirSpeed_en_ADDR, panAirSpeed_x_ADDR, panAirSpeed_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Throttle", pan.panThr, 24, 8, panThr_en_ADDR, panThr_x_ADDR, panThr_y_ADDR);
            
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Flight Mode", pan.panFlightMode, 12, 14, panFMod_en_ADDR, panFMod_x_ADDR, panFMod_y_ADDR);
...
//            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Wind Speed", pan.panWindSpeed, 24, 7, panWindSpeed_en_ADDR, panWindSpeed_x_ADDR, panWindSpeed_y_ADDR);
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Flight Times", pan.panTime, 1, 1, panTime_en_ADDR, panTime_x_ADDR, panTime_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("RSSI & LinkQuality", pan.panRSSI, 9, 11, panRSSI_en_ADDR, panRSSI_x_ADDR, panRSSI_y_ADDR);
...
//            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Channel Raw", pan.panCh, 1, 0, panCh_en_ADDR, panCh_x_ADDR, panCh_y_ADDR);
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Trip Odometer", pan.panDistance, 1, 11, panDistance_en_ADDR, panDistance_x_ADDR, panDistance_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Temperature", pan.panBaroTemp, 1, 3, panTemp_en_ADDR, panTemp_x_ADDR, panTemp_y_ADDR);
...
/*                    if (thing.Item1 == "Heading")
            ...
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Battery Voltage", pan.panBatt_A, 22, 3, panBatt_A_en_ADDR, panBatt_A_x_ADDR, panBatt_A_y_ADDR);
            //            panelitems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Battery B", pan.panBatt_B, 21, 3, panBatt_B_en_ADDR, panBatt_B_x_ADDR, panBatt_B_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Visible Sats", pan.panGPSats, 1, 11, panGPSats_en_ADDR, panGPSats_x_ADDR, panGPSats_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS Lock", pan.panGPL, 4, 11, panGPL_en_ADDR, panGPL_x_ADDR, panGPL_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS Coord", pan.panGPS, 1, 13, panGPS_en_ADDR, panGPS_x_ADDR, panGPS_y_ADDR);

            //second 8
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Heading Rose", pan.panRose, 22, 2, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR);
//            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Heading", pan.panHeading, 22, 11, panHeading_en_ADDR, panHeading_x_ADDR, panHeading_y_ADDR);
            ...
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Home Direction & Distance", pan.panHomeDir, 11, 11, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Home Line-Of-Sight Distance", pan.panHomeDis, 16, 12, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Waypoint Distance & ETA", pan.panWPDir, 1, 3, panWPDir_en_ADDR, panWPDir_x_ADDR, panWPDir_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Safety Radius & Eff/Glide Est.", pan.panSR_EGE, 1, 10, panSR_EGE_en_ADDR, panSR_EGE_x_ADDR, panSR_EGE_y_ADDR);
            // rssi

            // third 8
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS Altitude (ASL) & GPS AAH", pan.panAlt, 1, 12, panAlt_en_ADDR, panAlt_x_ADDR, panAlt_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Baro Altitude-Above-Home (AAH)", pan.panHomeAlt, 12, 12, panHomeAlt_en_ADDR, panHomeAlt_x_ADDR, panHomeAlt_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Climb Rate", pan.panClimb, 12, 13, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Energy Used & Battery Percent", pan.panBatteryPercent, 22, 11, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR);

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Current", pan.panCur_A, 22, 14, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR);

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Ground Speed", pan.panVel, 24, 11, panVel_en_ADDR, panVel_x_ADDR, panVel_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("3D Speed / Air Speed", pan.panAirSpeed, 12, 14, panAirSpeed_en_ADDR, panAirSpeed_x_ADDR, panAirSpeed_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Throttle", pan.panThr, 19, 13, panThr_en_ADDR, panThr_x_ADDR, panThr_y_ADDR);

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Flight Mode", pan.panFlightMode, 25, 1, panFMod_en_ADDR, panFMod_x_ADDR, panFMod_y_ADDR);
            ...
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Flight Times", pan.panTime, 1, 1, panTime_en_ADDR, panTime_x_ADDR, panTime_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("RSSI & LinkQuality", pan.panRSSI, 1, 1, panRSSI_en_ADDR, panRSSI_x_ADDR, panRSSI_y_ADDR);
            ...
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Trip Odometer", pan.panDistance, 1, 11, panDistance_en_ADDR, panDistance_x_ADDR, panDistance_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Temperature", pan.panBaroTemp, 1, 3, panTemp_en_ADDR, panTemp_x_ADDR, panTemp_y_ADDR);
            ...
            foreach (var thing in panelItems2)
            {
                if (thing != null)
                {
                    ...
                    else if (thing.Item1 == "Battery Voltage")
                    {
                        LIST_items2.Items.Add(thing.Item1, false);
                    ...
                    else if (thing.Item1 == "Heading Rose")
                    {
                        LIST_items2.Items.Add(thing.Item1, false);

                    }
                    else if (thing.Item1 == "Waypoint Distance & ETA")
                    {
                        LIST_items2.Items.Add(thing.Item1, false);
                        
                    }
                    else if (thing.Item1 == "Home Line-Of-Sight Distance")
                    {
                        LIST_items2.Items.Add(thing.Item1, false);

                    }
                    else if (thing.Item1 == "GPS Altitude (ASL) & GPS AAH")
                    {
                        LIST_items2.Items.Add(thing.Item1, false);

                    }
                    else if (thing.Item1 == "Ground Speed")
                    {
                        LIST_items2.Items.Add(thing.Item1, false);

                    }
                    else if (thing.Item1 == "Throttle")
                    {
                        LIST_items2.Items.Add(thing.Item1, false);
                    ...
                    else if (thing.Item1 == "Flight Times")
                    {
                        LIST_items2.Items.Add(thing.Item1, false);

                    }
                    else if (thing.Item1 == "Trip Odometer")
                    {
                        LIST_items2.Items.Add(thing.Item1, false);
            ...
            BATTCAPACITY_numeruc.Value = pan.batt_capacity;

            VOLTSENSOR_numericUpDown3.Value = (Convert.ToDecimal(pan.volt_div_ratio) / Convert.ToDecimal(100.0));
            CURRSENSOR_numericUpDown2.Value = (Convert.ToDecimal(pan.curr_amp_per_volt) / Convert.ToDecimal(100.0));
            CURRSENSOR_numericUpDown1.Value = (Convert.ToDecimal(pan.curr_amp_offset) / Convert.ToDecimal(10000.0));

//            RSSI_numeric_min1.Value = pan.rssipersent;
//            RSSI_numeric_max.Value = pan.rssical;
//            RSSI_RAW.Checked = Convert.ToBoolean(pan.rssiraw_on);

//            OVERSPEED_numeric1.Value = pan.overspeed;
...
//                OVERSPEED_label.Text = "Overspeed (mph)";
            ...
            MINVOLT_numeric.Value = (Convert.ToDecimal(pan.battv * pan.batt_type) / Convert.ToDecimal(100.0)) + Convert.ToDecimal(3.0);

            switch (pan.firmware_type)
            {
                case 1:
                    FIRMWARE_TYPE_radioButton1.Checked = true;
                    break;
                case 2:
                    FIRMWARE_TYPE_radioButton2.Checked = true;
                    break;
                case 3:
                    FIRMWARE_TYPE_radioButton3.Checked = true;
                    break;
                default:
                    pan.firmware_type = 1;
                    FIRMWARE_TYPE_radioButton1.Checked = true;
            ...
            switch (pan.batt_type)
            {
                case 0:
                    BATTYPE_radioButton2.Checked = true;
                    break;
                case 1:
                    BATTYPE_radioButton1.Checked = true;
                    break;
            }
...
//            else ONOFF_combo.SelectedIndex = 0; //reject garbage from the red file
            ONOFF_combo.SelectedIndex = 4; //JDL: Fixed to Ch7
...
//            CALLSIGNmaskedText1.Text = pan.callsign_str;
        ...
        void osdDraw1()
        {
            ...
            if (checkBox1.Checked)
            {
                for (int b = 1; b < 16; b++)
                {
                    for (int a = 1; a < 30; a++)
                    {
                        grfull.DrawLine(new Pen(Color.SlateGray, 1), a * 12 * scaleW, 0, a * 12 * scaleW, pictureBox1.Height);
                        grfull.DrawLine(new Pen(Color.SlateGray, 1), 0, b * 18 * scaleH, pictureBox1.Width, b * 18 * scaleH);
//                        grfull.DrawLine(new Pen(Color.FromArgb(120, 120, 120), 1), a * 12 * scaleW, 0, a * 12 * scaleW, pictureBox1.Height);
//                        grfull.DrawLine(new Pen(Color.FromArgb(120, 120, 120), 1), 0, b * 18 * scaleH, pictureBox1.Width, b * 18 * scaleH);
                    }
                }
            }
        ...
        void osdDraw2()
        {
            ...
            if (checkBox1.Checked)
            {
                for (int b = 1; b < 16; b++)
                {
                    for (int a = 1; a < 30; a++)
                    {
                        grfull.DrawLine(new Pen(Color.SlateGray, 1), a * 12 * scaleW, 0, a * 12 * scaleW, pictureBox2.Height);
                        grfull.DrawLine(new Pen(Color.SlateGray, 1), 0, b * 18 * scaleH, pictureBox2.Width, b * 18 * scaleH);
                    }
                }
            }
        ...
        private void OSD_Load(object sender, EventArgs e)
        {
            ...
            FIRMWARE_TYPE_radioButton1_CheckedChanged(sender, e);
...
//                eeprom[overspeed_ADDR] = pan.overspeed;
                ...
                eeprom[batt_capacity_ADDR] = (byte)(pan.batt_capacity & 0xff);
                eeprom[batt_capacity_ADDR + 1] = (byte)((pan.batt_capacity >> 8) & 0xff);

                eeprom[volt_div_ratio_ADDR] = (byte)(pan.volt_div_ratio & 0xff);
                eeprom[volt_div_ratio_ADDR + 1] = (byte)((pan.volt_div_ratio >> 8) & 0xff);

                eeprom[curr_amp_per_volt_ADDR] = (byte)(pan.curr_amp_per_volt & 0xff);
                eeprom[curr_amp_per_volt_ADDR + 1] = (byte)((pan.curr_amp_per_volt >> 8) & 0xff);

                eeprom[curr_amp_offset_ADDR] = (byte)(pan.curr_amp_offset & 0xff);
                eeprom[curr_amp_offset_ADDR + 1] = (byte)((pan.curr_amp_offset >> 8) & 0xff);

                eeprom[battv_ADDR] = pan.battv;
                eeprom[batt_type_ADDR] = pan.batt_type;
                eeprom[firmware_type_ADDR] = pan.firmware_type;
            ...
            if (sp.connectAP())
            {
                try
                {
                    ...
                    else if (current.Text == "Config")
                    {
                        for (int i = 0; i < 10; i++)
                        { //try to upload two times if it fail
                            spupload_flag = sp.upload(eeprom, (short)measure_ADDR, (short)(firmware_type_ADDR - measure_ADDR + 1), (short)measure_ADDR);
                            if (!spupload_flag)
                            {
                                if (sp.keepalive()) Console.WriteLine("keepalive successful (iter " + i + ")");
                                else Console.WriteLine("keepalive fail (iter " + i + ")");
...
//        const int panHeading_y_ADDR = 58;
        ...
        const int panSR_EGE_en_ADDR = 86;
        const int panSR_EGE_x_ADDR = 88;
        const int panSR_EGE_y_ADDR = 90;
        ...
        const int panFdata_en_ADDR = 218;
        const int panFdata_x_ADDR = 220;
        const int panFdata_y_ADDR = 222;
        const int panDistance_en_ADDR = 224;
        const int panDistance_x_ADDR = 226;
        const int panDistance_y_ADDR = 228;

        const int measure_ADDR = 890;           // keep this, even not in use!
...
//        const int CHK_VERSION = 1011;

        const int volt_div_ratio_ADDR = 1012;
        const int curr_amp_per_volt_ADDR = 1014;
        const int curr_amp_offset_ADDR = 1016;

        const int batt_type_ADDR = 1020;

        const int batt_capacity_ADDR = 1021;
        const int firmware_type_ADDR = 1023;    // keep this, even not in use!
...
/*            if (eeprom[CHK_VERSION] != VER) { // no match
            ...
            //Setup configuration panel
            pan.converts = 0; // eeprom[measure_ADDR]; // JDL Fixed
            //Modify units
            if (pan.converts == 0)
            {
//                UNITS_combo.SelectedIndex = 0; //metric
...
//            OVERSPEED_numeric1.Value = pan.overspeed;
            ...
            STALL_numeric.Value = pan.stall;
//            MessageBox.Show(Convert.ToString(pan.stall));

            pan.batt_capacity = eeprom[batt_capacity_ADDR] + (eeprom[batt_capacity_ADDR + 1] << 8);

            pan.volt_div_ratio = eeprom[volt_div_ratio_ADDR] + (eeprom[volt_div_ratio_ADDR + 1] << 8);
            pan.curr_amp_per_volt = eeprom[curr_amp_per_volt_ADDR] + (eeprom[curr_amp_per_volt_ADDR + 1] << 8);
            pan.curr_amp_offset = eeprom[curr_amp_offset_ADDR] + (eeprom[curr_amp_offset_ADDR + 1] << 8);
            ...
            pan.batt_type = eeprom[batt_type_ADDR];

            pan.battv = eeprom[battv_ADDR];

            pan.firmware_type = eeprom[firmware_type_ADDR];
...
//                        sw.WriteLine("{0}\t{1}", "Overspeed", pan.overspeed);
                        ...
                        sw.WriteLine("{0}\t{1}", "Battery Cell Warning Level", pan.battv);
                        sw.WriteLine("{0}\t{1}", "Battery Type", pan.batt_type);
                        sw.WriteLine("{0}\t{1}", "Battery Capacity", pan.batt_capacity);

                        sw.WriteLine("{0}\t{1}", "Volt Div Ratio", pan.volt_div_ratio);
                        sw.WriteLine("{0}\t{1}", "Current Amps Per Volt", pan.curr_amp_per_volt);
                        sw.WriteLine("{0}\t{1}", "Current Amps Offset", pan.curr_amp_offset);
...
//                        sw.WriteLine("{0}\t{1}", "Call Sign", pan.callsign_str);
                        sw.WriteLine("{0}\t{1}", "Firmware Type", pan.firmware_type);
                        sw.Close();
                    }
                }
                catch
            ...
            if (ofd.FileName != "")
            {
                try
                {
                    using (StreamReader sr = new StreamReader(ofd.OpenFile()))
                    {
                        ...
                        {
                            string[] strings = sr.ReadLine().Split(new char[] { '\t' }, StringSplitOptions.RemoveEmptyEntries);
                            if (strings[0] == "Units") pan.converts = 0; //byte.Parse(strings[1]);      // JDL Fixed
//                            else if (strings[0] == "Overspeed") pan.overspeed = byte.Parse(strings[1]);
                            else if (strings[0] == "Stall") pan.stall = byte.Parse(strings[1]);
                            else if (strings[0] == "Battery Cell Warning Level") pan.battv = byte.Parse(strings[1]);
                            else if (strings[0] == "Battery Type") pan.batt_type = byte.Parse(strings[1]);
                            else if (strings[0] == "Battery Capacity") pan.batt_capacity = int.Parse(strings[1]);

                            else if (strings[0] == "Volt Div Ratio") pan.volt_div_ratio = int.Parse(strings[1]);
                            else if (strings[0] == "Current Amps Per Volt") pan.curr_amp_per_volt = int.Parse(strings[1]);
                            else if (strings[0] == "Current Amps Offset") pan.curr_amp_offset = int.Parse(strings[1]);
...
//                            else if (strings[0] == "Call Sign") pan.callsign_str = strings[1];
                            else if (strings[0] == "Firmware Type") pan.firmware_type = byte.Parse(strings[1]);
                        }
...
/*
        ...
        private void MINVOLT_numeric_ValueChanged(object sender, EventArgs e)
        {
            if (pan.batt_type == 1)
            {
                pan.battv = (byte)((MINVOLT_numeric.Value - Convert.ToDecimal(3.0)) * 100);
            }
            else
            {
                MINVOLT_numeric.Value = Convert.ToDecimal(3.0);
            }
        }
        ...
        {
//            pan.callsign_str = CALLSIGNmaskedText1.Text;
...
//            CALLSIGNmaskedText1.Text = pan.callsign_str;
        ...
        private void gettingStartedToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                System.Diagnostics.Process.Start("https://librepilot.atlassian.net/wiki/spaces/LPDOC/pages/7274504/MinOPOSD+setup");
//                System.Diagnostics.Process.Start("https://code.google.com/p/arducam-osd/wiki/arducam_osd?tm=6");
        ...
        private void BATTCAPACITY_numeruc_ValueChanged(object sender, EventArgs e)
        {
            pan.batt_capacity = (int)BATTCAPACITY_numeruc.Value;
        }

        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            if (BATTYPE_radioButton1.Checked)
            {
                pan.batt_type = 1;
            }
            else
            ...
            byte temp_x = pan.battv;
            MINVOLT_numeric.Value = (Convert.ToDecimal(pan.battv * pan.batt_type) / Convert.ToDecimal(100.0)) + Convert.ToDecimal(3.0);
            pan.battv = temp_x;
        }

        private void FIRMWARE_TYPE_radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            if (FIRMWARE_TYPE_radioButton1.Checked)
            {
                pan.firmware_type = 1;
            }
            else
            {
                if (FIRMWARE_TYPE_radioButton2.Checked)
                {
                    pan.firmware_type = 2;
                }
                else
                {
                    if (FIRMWARE_TYPE_radioButton3.Checked)
                    {
                        pan.firmware_type = 3;
                    }
                    else
...
//                    groupBox9.Enabled = false;
        ...
        private void VOLTSENSOR_numericUpDown3_ValueChanged(object sender, EventArgs e)
        {
            pan.volt_div_ratio = (int)(VOLTSENSOR_numericUpDown3.Value * 100);
        }

        private void CURRSENSOR_numericUpDown2_ValueChanged(object sender, EventArgs e)
        {
            pan.curr_amp_per_volt = (int)(CURRSENSOR_numericUpDown2.Value * 100);
        }

        private void CURRSENSOR_numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            pan.curr_amp_offset = (int)(CURRSENSOR_numericUpDown1.Value * 10000);
        }
