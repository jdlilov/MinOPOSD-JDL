...
/*                if (st_safety_delta > 99999) {
                ...
                st_safety_delta = constrain(st_safety_delta, -9999, 99999);
            }
            else {
                st_safety_delta = 0.0;
            }
...
/*                if (batp_safety_delta > 99999) {
                ...
                batp_safety_delta = constrain(batp_safety_delta, -9999, 99999);
            }
            else {
...
/*        if (lt_safety_delta > 99999) {
        ...
        lt_safety_delta = constrain(lt_safety_delta, -9999, 99999);
    }
    else {
        osd_est_flight_time = 0.0;
        lt_safety_delta = 0.0;
